...
public class FamilyItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						FamiliesPackage.Literals.FAMILY__NAME, true, false, false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(FamiliesPackage.Literals.FAMILY__FATHER,
				FamiliesFactory.eINSTANCE.createFamilyMember()));

		newChildDescriptors.add(createChildParameter(FamiliesPackage.Literals.FAMILY__MOTHER,
				FamiliesFactory.eINSTANCE.createFamilyMember()));

		newChildDescriptors.add(createChildParameter(FamiliesPackage.Literals.FAMILY__SONS,
				FamiliesFactory.eINSTANCE.createFamilyMember()));

		newChildDescriptors.add(createChildParameter(FamiliesPackage.Literals.FAMILY__DAUGHTERS,
				FamiliesFactory.eINSTANCE.createFamilyMember()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == FamiliesPackage.Literals.FAMILY__FATHER
